...
try:
    print(">>> Aplicando migração: Adicionando fonetica à tabela dizimistas...")
    ...
    try:
        cursor.execute("ALTER TABLE dizimistas ADD fonetica VARCHAR2(1000)")
        print(" [+] Coluna fonetica adicionada com sucesso!")
